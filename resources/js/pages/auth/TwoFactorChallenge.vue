        ...
        <template v-if="!showRecoveryInput">
            ...
            >
                ...
                <div class="flex flex-col items-center gap-4">
                    <p class="text-sm font-medium text-muted-foreground">Entrez le code à 6 chiffres</p>
                    <InputOTP
                        id="otp"
                        v-model="code"
                        :maxlength="6"
                    ...
                    >
                        <InputOTPGroup>
                            <InputOTPSlot
                                ...
                                :key="index"
                                :index="index - 1"
                                class="h-12 w-12 rounded-xl border-2 border-border text-lg font-semibold transition-all focus:border-primary focus:ring-2 focus:ring-primary/20"
                            />
                        </InputOTPGroup>
                    </InputOTP>
                ...
                <Button type="submit" class="h-11 w-full rounded-xl bg-gradient-to-r from-primary to-primary-dark font-semibold text-white shadow-lg shadow-primary/20 transition-all duration-300 hover:shadow-xl hover:shadow-primary/30 hover:-translate-y-0.5" :disabled="processing">
                ...
                <div class="text-center text-sm text-muted-foreground">
                    ...
                    <button
                        type="button"
                        class="font-semibold text-primary transition-all hover:text-primary-dark hover:underline"
