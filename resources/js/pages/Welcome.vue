        ...
        <section class="py-32 bg-slate-50 dark:bg-slate-900/50">
            <div class="max-w-7xl mx-auto px-6 lg:px-12 space-y-16">
                <div class="flex flex-col md:flex-row md:items-end justify-between gap-8">
                    <div class="space-y-4">
                        <h2 class="text-5xl font-black tracking-tight">Produits Vedettes</h2>
                        <p class="text-slate-500 max-w-md">Découvrez nos produits les plus populaires et les nouveautés incontournables.</p>
                    </div>
                    <Link :href="products.index().url" class="group flex items-center gap-2 font-bold text-blue-600">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    >
                        <img 
                            :src="cat.image" 
                            :alt="cat.name" 
                            class="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-110 opacity-60 group-hover:opacity-100"
                        />
                        ...
                        <div class="absolute bottom-8 left-8 z-20 space-y-2">
                            <h4 class="text-2xl font-black text-white">{{ cat.name }}</h4>
                            <p class="text-sm text-white/60 font-bold tracking-widest uppercase group-hover:text-white transition-colors">Découvrir</p>
                        </div>
                    </div>
                </div>
            </div>
